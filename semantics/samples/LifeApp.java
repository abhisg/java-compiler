/*
    ...
    Copyright 1996-97 by Paul B. Callahan, callahan@inf.ethz.ch
*/
...
class generator extends LifeGenerator
{
	void main()
	{
		LifeGenerator obj=new LifeGenerator();
		obj.setScroll(10);
		int x=getPlotX(10)+getPlotY(5);
	}
}
